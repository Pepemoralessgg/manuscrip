/**
 * Lógica compartida: hints de contexto para scores (0–100).
 * Usado por app.js (HTML) y lib/pdfReport.js (texto plano).
 */

export function buildScoreHintParts(dim, raw) {
...
export function buildScoreHintPlainText(dim, raw) {
