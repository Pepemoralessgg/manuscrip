/**
 * Cliente Supabase y fetch con JWT — solo APIs del navegador (sin CommonJS en cliente).
 * La lógica de score hints está inline para no depender de import de .mjs (Vercel / CDN).
 */
