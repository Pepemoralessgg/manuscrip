  ...
  "personas": [
    {
      ...
      "puntoAbandono": "capítulo X o null",
      "estrellasAmazon": 1
    },
    {
...
function buildBenchmarkPlaceholder(manuscript, nlpGlobal) {
  return {
    genre: manuscript.genre,
    note:
      "Benchmark de mercado: requiere catálogo propio de referencia. Valores mostrados son ilustrativos.",
    illustrative: {
      avgChapterWordsPeer: Math.round((nlpGlobal?.wordCount || 1000) / Math.max(1, manuscript.chapterCount || 1)),
      dialogueRatioPeer: 0.22,
      lexicalRichnessPeer: 0.42
    },
    yourSnapshot: {
      avgChapterWords: Math.round((nlpGlobal?.wordCount || 0) / Math.max(1, manuscript.chapterCount || 1)),
      lexicalRichness: nlpGlobal?.lexicalRichness ?? null
    }
  };
}
...
Devuelve SOLO JSON con esta forma exacta:
{
  ...
  "personas": {
    "personas": [
      { "rol": "lector_casual", "feedback": "máx 500 caracteres", "puntoAbandono": "cap o null", "estrellasAmazon": 1 },
      { "rol": "editor_profesional", "feedback": "máx 500 caracteres", "puntoAbandono": "cap o null", "estrellasAmazon": 1 },
      { "rol": "lector_critico", "feedback": "máx 500 caracteres", "puntoAbandono": "cap o null", "estrellasAmazon": 1 },
      { "rol": "lectora_genero", "feedback": "máx 500 caracteres", "puntoAbandono": "cap o null", "estrellasAmazon": 1 }
    ]
  },
  "hook": {
    "preguntaDramatica": "sí|no|parcial",
