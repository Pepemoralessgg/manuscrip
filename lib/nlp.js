...
/** Palabras que suelen ir en mayúscula por reglas tipográficas pero no son nombres propios */
const NAME_STOPWORDS_ES = new Set(
  [
    "pues",
    "mas",
    "merced",
...
function extractCharacterCandidates(text, limit = 25) {
  ...
  while ((m = re.exec(text)) !== null) {
    ...
    if (NAME_STOPWORDS_ES.has(w.toLowerCase())) continue;
